...
DEFAULT_FIELD_DEFS = {
    "Transacciones": [
        ...
        _single_select("Categoría", ["Alimentación", "Deudas", "Inversiones", "Ocio", "Otros", "Ropa", "Sueldo", "Tecnología", "Transporte", "Vivienda"]),
        _text("Subcategoría"),
    ...
    "Deudas": [
        ...
        _single_select("CuentaAsociada", ["Efectivo", "BCP", "AMEX"]),
        _text("Periodo"),
        _date("FechaCorte"),
    ],
